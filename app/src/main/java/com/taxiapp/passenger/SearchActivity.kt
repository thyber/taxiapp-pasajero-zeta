...
class SearchActivity : AppCompatActivity() {
    ...
    private lateinit var mapSelectLauncher: androidx.activity.result.ActivityResultLauncher<Intent>
    ...
    private fun setupActivityResultLauncher() {
        mapSelectLauncher = registerForActivityResult(androidx.activity.result.contract.ActivityResultContracts.StartActivityForResult()) { result ->
        ...
        etDestination.addTextChangedListener(object : TextWatcher {
            ...
            override fun onTextChanged(s: CharSequence?, start: Int, before: Int, count: Int) {
                ...
                if (query.isNotEmpty()) {
                    ...
                    btnPedirTaxi.backgroundTintList = android.content.res.ColorStateList.valueOf(0xFF2563eb.toInt())
                } else {
                    btnPedirTaxi.isEnabled = false
                    btnPedirTaxi.backgroundTintList = android.content.res.ColorStateList.valueOf(0xFF9ca3af.toInt())
                }
